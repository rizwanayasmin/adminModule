...
function createData(empid, name,department,designation, status,comments ) {
  ...
  const rows = [
    createData("PRE-KG","2400","English","Online class","Chapter 1", "present"),
    createData("PRE-KG","2400","English","Online clas","Chapter 1", "present"),
    createData("PRE-KG","2400","English","Online clas","Chapter 1", "present"),
  ];
//dummy end 
  ...
  const toggle = () => {
    ...
    return(
        <div className="container-fluid">
            <img src={ImgSubject} style={{width:"100%"}}/>
        {/* <Card>
        <CardHeader>
        ...
        <div className='create_attendence_parent'>
            <h4 className="title_subject">Subject</h4>
            <Row>
                <Col >
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow style={{backgroundColor:'#fcf1f1'}}>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Code</TableCell>
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Subject Name</TableCell>
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Subject Type</TableCell>
