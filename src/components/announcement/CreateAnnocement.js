...
const CreateAnnocement = ({ modal, toggle }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} size="lg">
        <ModalHeader toggle={toggle}>Create Annocement</ModalHeader>
        <ModalBody>
          <div>
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow style={{backgroundColor:'#fcf1f1'}}>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Size Progress</TableCell>
