...
const handleOpen = () => {
  ...
  const toggle = () => {
    ...
    return(
        ...
        <Card>
        <CardHeader>
          <CardTitle style={{ color: "#fd868c" , fontWeight:"600"}}>Calender</CardTitle>
        </CardHeader>
        <CardBody>
        ...
        {/* <Row>
            <Col sm="12">
            <h4 style={{ color: "#fd868c" , fontWeight:"600",padding:'12px'}}>Calender</h4>
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow style={{backgroundColor:'#fcf1f1'}}>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>End</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow >
              ...
              <TableCell align="center" >Periodic Assessment 1</TableCell>
