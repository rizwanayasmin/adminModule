...
const CreateExtraCurricular = ({ modal, toggle }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} size="lg">
        <ModalHeader toggle={toggle}>Create Extra Curricular</ModalHeader>
        <ModalBody>
          <div>
              ...
              <Row style={{marginBottom:"12px"}}>
                ...
                <Col sm="12">
                  ...
                  <Select
                    id="classroom"
                    options={[
                        { value: "1st Prize", label: "1st Prize" },
                        { value: "2st Prize", label: "2st Prize" },
                      ]}
