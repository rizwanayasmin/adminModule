...
const handleOpen = () => {
  ...
  const toggle = () => {
    ...
    return(
        ...
        <Row>
            <Col sm="12">
            <h4 style={{ color: "#fd868c" , fontWeight:"600",padding:'12px'}}>Extra Curricular</h4>
                    ...
                    <Col>
                        ...
                        <Col>
                            ...
                            <Select
                                id="competetion"
                                value={{ value: "Inter-School", label: "Inter-School" }}
                                options={[
                                    { value: "Intra-School", label: "-School" },
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          ...
          <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Institution</TableCell>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Competition</TableCell>
