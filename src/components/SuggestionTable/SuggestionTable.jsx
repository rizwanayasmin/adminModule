...
const handleOpen = () => {
  ...
  const toggle = () => {
    ...
    return(
        ...
        <Row>
            <Col sm="12">
            <h4 style={{ color: "#fd868c" , fontWeight:"600",padding:'12px'}}>Suggestion & Feedback</h4>

            </Col>
        </Row>
            
                    <div className="discipline_filer">
                            ...
                            <div className="insti_label_multi"><Label>Parent/Teacher</Label>
                            <Select
                                id="classroom"
                                options={[
