...
import { faEye, faTrash, faPencil ,faPlus, faLocationArrow,faEnvelope} from "@fortawesome/pro-duotone-svg-icons";
import {
  ChevronsLeft,
  ChevronsRight,
  Plus,
...
const SmsApplication = ({ modal1, toggle1 }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={modal1} toggle1={toggle1} size="lg">
        <ModalHeader toggle1={toggle1}>View Application</ModalHeader>
        <ModalBody>
          <div>
            <Row>
                <Col sm="6">
