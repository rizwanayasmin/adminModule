...
import {
  ...
  import { faEye, faFileUpload, faPencil, faPencilAlt, faSave, faTrash, faTrashAlt, faTrophyAlt } from "@fortawesome/pro-duotone-svg-icons";
  ...
  const toggle = () => {
    ...
    return(
        ...
        <div className='create_attendence_parent'>
            ...
            <h4 style={{ color: "#fd868c" , fontWeight:"600",padding:'12px'}}>Savings Passbook</h4>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:'space-between'}}>
                            ...
                            <div style={{width:'200px',marginLeft:'12px'}}><Label>Level</Label>
                            <Select
                                id="classroom"
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          ...
          <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Institute</TableCell>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>ContestType</TableCell>
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Contest</TableCell>
            {/* <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Grade</TableCell> */}
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Amount</TableCell>
