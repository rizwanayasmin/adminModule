...
import {
  ...
  import { faArrowToLeft, faEye, faFileUpload, faPencil, faPencilAlt, faSave, faTrash, faTrashAlt } from "@fortawesome/pro-duotone-svg-icons";
...
import ViewSchoolResult from "../SchoolResult/ViewSchoolResult"
...
const handleOpen = () => {
  ...
  const toggle = () => {
    ...
    return(
        ...
        <Row>
            <Col sm="12">
            <h4 style={{ color: "#fd868c" , fontWeight:"600",padding:'12px'}}>School Result</h4>
                    ...
                    <Col>
                        ...
                        <Button className="mr-1" color="primary" href="/resultview" outline >
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          ...
          <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Institution</TableCell>
            ...
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Class Average</TableCell>
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Top 10 Average</TableCell>
            <TableCell align="center" style={{color:'#c3272b',fontWeight:'600'}}>Last 10 Average</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <TableRow >
              ...
              <TableCell align="center" >BEAUTIFUL</TableCell>
              <TableCell align="center" >Mathematics - Oral</TableCell>
